			...
			<div className="grid grid-cols-6 grid-rows-2 items-center gap-x-4">
				...
				<div className="self-end">
					<button
						onClick={handleAddon}
						type="button"
						className="inline-flex items-center gap-x-1.5 rounded-md bg-cyan-600 px-2.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
					>
						Add
